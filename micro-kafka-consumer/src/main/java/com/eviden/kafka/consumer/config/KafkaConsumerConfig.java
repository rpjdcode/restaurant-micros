package com.eviden.kafka.consumer.config;
...
public class KafkaConsumerConfig {
	...
	public Map<String, Object> consumerConfig() {
		...
		// Objeto que serializa un mensaje
	...
	@Bean
	KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> consumer() {
